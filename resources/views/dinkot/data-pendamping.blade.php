...
@section('content')
	<div class="container container-compose">
		<div class="d-flex justify-content-between align-items-center mb-2">
			<h4 id="title">Data Pendamping</h4>
			<a href="{{ url('unduh-pendamping-lengkap/parent_user_id') }}" class="btn btn-sm btn-outline-primary mb-1" target="_blank">Unduh Pendamping Lengkap</a>
		</div>
		...
		<div class="none" id="empty">
			<div class="d-flex flex-column justify-content-center align-items-center state">
				...
				<h5>Belum ada data pendamping</h5>
			</div>
		</div>
		<div id="loading">
			<div class="d-flex flex-column justify-content-center align-items-center state">
...
@section('script')
	<script src="{{asset('api/dinkot/data-pendamping.js')}}"></script>
@endsection
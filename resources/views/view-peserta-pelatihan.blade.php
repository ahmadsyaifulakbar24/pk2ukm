...
@section('title','User Peserta Pelatihan')

@section('content')
	<div class="container">
		<div class="d-flex justify-content-between align-items-center mb-2">
			<h4 id="title">User Peserta Pelatihan</h4>
		</div>
		...
		<div class="none" id="empty">
			<div class="d-flex flex-column justify-content-center align-items-center state">
				...
				<h5>Belum ada user peserta pelatihan</h5>
			</div>
		</div>
		<div id="loading">
			<div class="d-flex flex-column justify-content-center align-items-center state">
...
@section('script')
	...
	<script src="{{asset('api/view-peserta-pelatihan.js')}}"></script>
@endsection